<?php
	...
	if (isset($_POST['submit'])){
		...
		$update = "UPDATE hikerlist SET attendance='Present',departureTime='$timenow',departureDate='$datenow' WHERE id='$id'";
...
<div id="delForm">
		<form method="POST">
			Does this hiker present?<input type="hidden" name="id" class="inputFields" value="<?php echo $id;?>" required=""><br><br>
