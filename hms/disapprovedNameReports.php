<?php
	...
	$queryApprove="SELECT *,COUNT(status) as total_approve FROM register AS register LEFT JOIN setspot ON register.setspot_id = setspot.id WHERE register.status='Disapproved' AND register.setspot_id = " . $_GET['setspotId'];
	...
	$queryApprove_show="SELECT * FROM register AS register LEFT JOIN setspot ON register.setspot_id = setspot.id LEFT JOIN users ON register.user_id= users.id WHERE register.status='Disapproved' AND register.setspot_id = " . $_GET['setspotId'];
