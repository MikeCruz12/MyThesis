<?php
	...
	if(isset($_POST['savepass'])){
		...
		if($password!==$conpass){
		...
		else if(password_exists(md5($password),$con)){
			...
			if(mysqli_query($con,"UPDATE users SET password='$password' WHERE username='$username'")){
	...
	<div id="loginwrapper2">
		<div id="formdiv"> 
			<form  class="form-style" method="POST" action="changepassword.php">
