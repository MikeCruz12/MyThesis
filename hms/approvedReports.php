      ...
      <body>  
           ...
           <div class="container">  
            ...
            <th>Action</th>
                          ...
                          <?php  
                          $queryApprove_show="SELECT * FROM register LEFT JOIN setspot ON register.setspot_id = setspot.id LEFT JOIN users ON register.user_id = users.id WHERE status='Approved' ORDER BY datenow desc";
