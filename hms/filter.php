      ...
      <body>  
           <div class="container">
            ...
            <th>Action</th>
                          ...
                          <?php  
                          $queryApprove_show="SELECT * FROM register LEFT JOIN setspot ON register.setspot_id = setspot.id LEFT JOIN users ON register.user_id = users.id WHERE status='Approved' AND done = 'done' AND arriveStatus='Arrived' AND register.date BETWEEN '".$_POST["from_date"]."' AND '".$_POST["to_date"]."' ORDER BY datenow desc";
