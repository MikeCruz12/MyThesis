...
<body>
	<div class="container" style="padding-bottom: 20px;margin-top: 10px;">
		...
		<h1 align="center">Approval Form #<?php echo $id; ?> Attendance</h1>
		...
		<div class="table-responsive">
             ...
             <div class="table-responsive">
                <table class="tables" width="100%" style="padding: 0px;">
                    ...
                    <tbody align="center">
                    	...
                    	<?php  
                         	$query = "SELECT * FROM hikerlist WHERE register_id='$id' AND status='Approved'";
							...
							if($response){
								...
								?>
									<tr>
										...
										<td style="font-size: 20px;"><a href="attend.php?id=<?php echo $idHiker;?>" class="btn btn-success btn-sm Add">Present</a>&nbsp<a href="absent.php?id=<?php echo $idHiker;?>" class="btn btn-danger btn-sm Add">Absent</a></td>
            ...
            if (isset($_POST['send'])){
				...
				$update = "UPDATE register SET done='done',groupTime='$timenow',groupDate='$datenow' WHERE id='$id'";
