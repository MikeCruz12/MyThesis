<?php
	...
	<div id="updateDiv">
		<form class="form-style" method="POST" action="update.php">
		<h1>Edit Client Profile</h1>
		<div class="col-50">
			<input type="hidden" name="idNumber" class="inputFields" value="<?php echo $id;?>" required="">
			<label><b>Firstname</b></label>
			<input type="text" name="fname" pattern="[a-zA-Z]+" title="Invalid, should only contain letters" class="inputFields" required="" value="<?php echo $firstname; if(isset($_POST['fname'])){ echo $_POST['fname'];}?>"/><br><br>
			<label><b>Middlename</b></label>
			<input type="text" name="mname" pattern="[a-zA-Z]+" title="Invalid, should only contain letters" class="inputFields" required="" value="<?php echo $middlename; if(isset($_POST['mname'])){ echo $_POST['mname'];}?>"/><br><br>
			<label><b>Lastname</b></label>
			<input type="text" name="lname" pattern="[a-zA-Z]+" title="Invalid, should only contain letters" class="inputFields" required="" value="<?php echo $lastname; if(isset($_POST['lname'])){ echo $_POST['lname'];}?>"/><br><br>
