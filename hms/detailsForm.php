...
<body>
	<div class="container" style="padding-bottom: 20px;margin-top: 10px;">
		...
		<div class="table-responsive">
             ...
             <div class="table-responsive">
                <table class="tables" width="100%" style="padding: 0px;">
                    ...
                    <tbody align="center">
                    	...
                    	<?php  
                         	$query = "SELECT * FROM hikerlist WHERE register_id='$id' AND hikerArrive='' AND status='Approved' AND attendance='Present'";
            ...
            </div><div style="text-align: center;font-weight: bold;font-size: 20px; ">Departure to Base: <?php echo $gdd.', '. $gdt; ?></div><br>
             ...
             <div class="table-responsive">
                <table class="tables" width="100%" style="padding: 0px;">
                    ...
                    <tbody align="center">
                    	...
                    	<?php  
                         	$query = "SELECT * FROM hikerlist WHERE register_id='$id' AND status='Approved' AND attendance='Absent'";
